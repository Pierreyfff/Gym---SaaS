        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="bg-white rounded-lg shadow p-6 border-t-4 border-gray-200">
          ...
          <div className="bg-white rounded-lg shadow p-8 text-center">
            ...
            <p className="text-gray-600 font-medium mb-2">No se encontraron planes</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredPlanes.map((plan) => (
              <div
                key={plan.id}
                className="bg-white rounded-lg shadow hover:shadow-lg transition p-6 border-t-4 border-purple-500"
              >
                <div className="mb-4">
