      ...
      <header className="bg-white dark:bg-gray-950 shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Renovar Membresía</h1>
          </div>
          <div className="flex items-center gap-4">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between mt-2">
            ...
            <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Pago</span>
            <span className="text-xs font-medium text-gray-600 dark:text-gray-400">Confirmación</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-950 rounded-lg shadow p-6">
          ...
          {currentStep === 1 && (
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Seleccionar Plan</h2>
              </div>

              {planes.length === 0 ? (
                <div className="text-center py-8">
                  <p className="text-gray-600 dark:text-gray-400 mb-4">No hay planes disponibles</p>
                  <button
                ...
                <div className="grid grid-cols-1 md: grid-cols-2 gap-4">
                  {planes.map((plan) => (
                    ...
                    >
                      ...
                      {plan.descripcion && (
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">{plan.descripcion}</p>
                      )}
                      <div className="flex items-baseline gap-2">
                        <span className="text-2xl font-bold text-green-600">
                          {formatCurrency(plan.precio)}
                        </span>
                        <span className="text-sm text-gray-500 dark:text-gray-400">/ {plan.duracionDias} días</span>
                      </div>
                    </button>
                  ))}
                </div>
          ...
          {currentStep === 2 && (
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Registrar Pago</h2>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="font-semibold text-gray-900 dark:text-gray-100">{selectedPlan?.nombre}</span>
                  </div>
                  <div className="flex justify-between items-center mb-2">
          ...
          {currentStep === 3 && (
            <div className="text-center py-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Renovación Exitosa</h2>
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                La membresía ha sido renovada y el pago registrado correctamente
              </p>

              <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg max-w-md mx-auto mb-6">
                <div className="space-y-3 text-left">
                  ...
                  <div className="flex justify-between pt-3 border-t">
                    <span className="font-semibold text-gray-900 dark:text-gray-100">Total pagado:</span>
          ...
          {currentStep < 3 && (
            <div className="flex justify-between mt-8 pt-6 border-t">
              <button
                ...
                className="flex items-center gap-2 px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 font-medium transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
