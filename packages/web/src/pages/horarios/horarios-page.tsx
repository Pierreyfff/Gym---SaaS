                    ...
                    {!editando ? (
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex items-center gap-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold px-4 py-2 rounded-lg transition text-sm"
                          disabled={guardando}
                        >
                          <X className="w-4 h-4" />
                          Cancelar
                        ...
                        return (
                          <div
                            ...
                            className={`flex items-center gap-4 p-3 rounded-lg border ${
                              horario ? 'border-gray-200' : 'border-dashed border-gray-300'
                            }`}
                          >
