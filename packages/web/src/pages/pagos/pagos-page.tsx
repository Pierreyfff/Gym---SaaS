      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-6">
          ...
          >
            ...
            <p className="text-2xl font-bold text-gray-900">{estadoStats.todos}</p>
          </button>
          ...
          >
            ...
            <p className="text-2xl font-bold text-gray-600">{estadoStats.rechazado}</p>
          </button>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow p-8 text-center">
            ...
            <p className="text-gray-600 font-medium mb-2">No se encontraron pagos</p>
                ...
                {filteredPagos.map((pago) => (
                  <tr key={pago.id} className="hover:bg-gray-50 transition">
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-sm text-gray-500">{pago.membresia.cliente.email}</div>
                    </td>
